...
const languagePoints = {
  ...
  nextQuestion.addEventListener("click", async () => {
    ...
    if (nextQuestion.classList.contains("finish")) {
      ...
      languagePoints["JavaScript"] += parseInt(data[questionNumber].answers[selectAnswersNum]["points"]["JavaScript"])
      languagePoints["Python"] += parseInt(data[questionNumber].answers[selectAnswersNum]["points"]["Python"])
      languagePoints["Java"] += parseInt(data[questionNumber].answers[selectAnswersNum]["points"]["Java"])
      languagePoints["C++"] += parseInt(data[questionNumber].answers[selectAnswersNum]["points"]["C++"])
    ...
    if (isActive) {
      if (questionNumber >= data.length - 1) {
        ...
        // Evaluate answers points function languagePoints add
        languagePoints["JavaScript"] += parseInt(data[questionNumber - 1].answers[selectAnswersNum]["points"]["JavaScript"])
        languagePoints["Python"] += parseInt(data[questionNumber - 1].answers[selectAnswersNum]["points"]["Python"])
        languagePoints["Java"] += parseInt(data[questionNumber - 1].answers[selectAnswersNum]["points"]["Java"])
        languagePoints["C++"] += parseInt(data[questionNumber - 1].answers[selectAnswersNum]["points"]["C++"])
